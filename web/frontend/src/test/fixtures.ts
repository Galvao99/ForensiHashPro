...
export const authFixture: AuthResponse = {
  user: { id: 'user-test', name: 'Pessoa Teste', email: 'person@example.test', role: 'USER', analysis_profile: 'PRO', is_active: true, created_at: '2026-08-08T12:00:00Z', last_login_at: null },
...
export const analysisFixture: AnalysisContract = {
  ...
  execution: { runtime: 'python', analysis_profile: 'pro', started_at: '2026-08-08T14:31:58Z', finished_at: '2026-08-08T14:32:00.400Z' },
}
